...
{
    [TestFixture, Category("BigDecimalAbs")]
    public class BigDecimalAbsTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void Abs()
        {
            ...
            var t = (string expected, BigDecimalArgument<BigDecimal> value) =>
            {
                BigDecimalTests.assertEqual(expected, bigDecimalFactory.BigDecimal(value).Abs().ValueOf());
            };
            ...
            t("999.999", 999.999);
            t("999.999", "-999.999");
            t("1", bigDecimalFactory.BigDecimal(-1));
            t("1", bigDecimalFactory.BigDecimal("-1"));
            t("0.001", bigDecimalFactory.BigDecimal(0.001));
            t("0.001", bigDecimalFactory.BigDecimal("-0.001"));
            ...
            t = (string expected, BigDecimalArgument<BigDecimal> value) =>
            {
                BigDecimalTests.assertEqual(expected, bigDecimalFactory2.BigDecimal(value).Abs().ValueOf());
            };
