...
{
    [TestFixture, Category("BigDecimalFloor")]
    public class BigDecimalFloorTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void Floor()
        {
            ...
            {
                BigDecimalTests.assertEqual(expected, bigDecimalFactory.BigDecimal(n).Floor().ValueOf());
            };
            ...
            bigDecimalFactory.Config.ToExpNeg = -100;
            bigDecimalFactory.Config.ToExpPos = 100;
