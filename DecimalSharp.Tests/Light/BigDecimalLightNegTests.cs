...
{
    [TestFixture, Category("BigDecimalLightNeg")]
    public class BigDecimalLightNegTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void Neg()
        {
            ...
            {
                BigDecimalTests.assertEqual(expected, bigDecimalFactory.BigDecimal(n).Neg().ValueOf());
            };
